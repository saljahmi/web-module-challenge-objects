...
function createMenuItem(name, cost, category){
  const menuItem = {name, cost, category};
  return menuItem;
}

/* Task 1b: use your function to create 3 more menu items. You may add any items to the menu that you'd like */

const fries = createMenuItem("Fries", 5, "Lunch");
console.log(fries);
...
function getLastReview(array) {
  return reviews[reviews.length -1].name + " gave the restauraunt a " + reviews[reviews.length-1].rating + " star review and their feedback was: " + reviews[reviews.length-1].feedback;    
} 
...
const myCar = carMaker(20);
console.log(myCar);
console.log(myCar.drive(40));
